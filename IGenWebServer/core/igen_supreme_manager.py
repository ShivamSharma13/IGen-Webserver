...
def supreme_manager(user_project_dir, user_vcf_file_path, dna_service_provider):
	...
	subprocess.call("python3 ../pipeline-scripts/merge.py -r " + reference_token_file_for_merge + " -t " + os.path.join(user_project_dir, "inputfile_filtered") + " -o " + os.path.join(user_project_dir, "post_knn_merge"), " -c " + user_vcf_file_path, shell=True)
